 ...
 */
function media2wp_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'media2wp' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'media2wp' ),
...
add_action( 'widgets_init', 'media2wp_widgets_init' );
...
function media2wp_scripts() {
	...
	wp_enqueue_script( 'media2wp-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'media2wp-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
